...
import { CECRegistry, RegisteredAsset, SetRootAccess, RevokedAccess, UpdatedBeneficiary } from '../generated/CECRegistry/CECRegistry';
...
export function handleSetRootAccessCEC(event: SetRootAccess): void {
