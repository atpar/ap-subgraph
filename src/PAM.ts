...
import { PAMRegistry, RegisteredAsset, SetRootAccess, RevokedAccess, UpdatedBeneficiary } from '../generated/PAMRegistry/PAMRegistry';
...
export function handleSetRootAccessPAM(event: SetRootAccess): void {
