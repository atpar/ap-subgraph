...
export class PAMActor__decodeCollateralObjectResult {
  value0: Address;
  value1: BigInt;
...
export class PAMActor__decodeEventResult {
  value0: i32;
  value1: BigInt;
...
export class PAMActor extends SmartContract {
  static bind(address: Address): PAMActor {
    return new PAMActor("PAMActor", address);
  }
  ...
  decodeCollateralObject(
    ...
    return new PAMActor__decodeCollateralObjectResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_decodeCollateralObject(
    object: Bytes
  ): CallResult<PAMActor__decodeCollateralObjectResult> {
    ...
    return CallResult.fromValue(
      new PAMActor__decodeCollateralObjectResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
  ...
  decodeEvent(_event: Bytes): PAMActor__decodeEventResult {
    let result = super.call("decodeEvent", [
      EthereumValue.fromFixedBytes(_event)
    ]);

    return new PAMActor__decodeEventResult(
      result[0].toI32(),
      result[1].toBigInt()
    );
  }

  try_decodeEvent(_event: Bytes): CallResult<PAMActor__decodeEventResult> {
    ...
    let value = result.value;
    return CallResult.fromValue(
      new PAMActor__decodeEventResult(value[0].toI32(), value[1].toBigInt())
    );
  }
...
export class InitializeCallTermsStruct extends EthereumTuple {
  ...
  get gracePeriod(): InitializeCallTermsGracePeriodStruct {
    return this[38].toTuple() as InitializeCallTermsGracePeriodStruct;
  }

  get delinquencyPeriod(): InitializeCallTermsDelinquencyPeriodStruct {
    return this[39].toTuple() as InitializeCallTermsDelinquencyPeriodStruct;
  }

  get cycleOfInterestPayment(): InitializeCallTermsCycleOfInterestPaymentStruct {
    return this[40].toTuple() as InitializeCallTermsCycleOfInterestPaymentStruct;
  }

  get cycleOfRateReset(): InitializeCallTermsCycleOfRateResetStruct {
    return this[41].toTuple() as InitializeCallTermsCycleOfRateResetStruct;
  }

  get cycleOfScalingIndex(): InitializeCallTermsCycleOfScalingIndexStruct {
    return this[42].toTuple() as InitializeCallTermsCycleOfScalingIndexStruct;
  }

  get cycleOfFee(): InitializeCallTermsCycleOfFeeStruct {
    return this[43].toTuple() as InitializeCallTermsCycleOfFeeStruct;
  }
}
