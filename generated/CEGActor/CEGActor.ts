...
export class CEGActor__decodeCollateralObjectResult {
  value0: Address;
  value1: BigInt;
...
export class CEGActor__decodeEventResult {
  value0: i32;
  value1: BigInt;
...
export class CEGActor extends SmartContract {
  static bind(address: Address): CEGActor {
    return new CEGActor("CEGActor", address);
  }
  ...
  decodeCollateralObject(
    object: Bytes
  ): CEGActor__decodeCollateralObjectResult {
    let result = super.call("decodeCollateralObject", [
      EthereumValue.fromFixedBytes(object)
    ]);

    return new CEGActor__decodeCollateralObjectResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_decodeCollateralObject(
    object: Bytes
  ): CallResult<CEGActor__decodeCollateralObjectResult> {
    ...
    return CallResult.fromValue(
      new CEGActor__decodeCollateralObjectResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
  ...
  decodeEvent(_event: Bytes): CEGActor__decodeEventResult {
    let result = super.call("decodeEvent", [
      EthereumValue.fromFixedBytes(_event)
    ]);

    return new CEGActor__decodeEventResult(
      result[0].toI32(),
      result[1].toBigInt()
    );
  }

  try_decodeEvent(_event: Bytes): CallResult<CEGActor__decodeEventResult> {
    ...
    let value = result.value;
    return CallResult.fromValue(
      new CEGActor__decodeEventResult(value[0].toI32(), value[1].toBigInt())
    );
  }
...
export class InitializeCallTermsStruct extends EthereumTuple {
  ...
  get gracePeriod(): InitializeCallTermsGracePeriodStruct {
    return this[21].toTuple() as InitializeCallTermsGracePeriodStruct;
  }

  get delinquencyPeriod(): InitializeCallTermsDelinquencyPeriodStruct {
    return this[22].toTuple() as InitializeCallTermsDelinquencyPeriodStruct;
  }

  get cycleOfFee(): InitializeCallTermsCycleOfFeeStruct {
    return this[23].toTuple() as InitializeCallTermsCycleOfFeeStruct;
  }

  get contractReference_1(): InitializeCallTermsContractReference_1Struct {
    return this[24].toTuple() as InitializeCallTermsContractReference_1Struct;
  }

  get contractReference_2(): InitializeCallTermsContractReference_2Struct {
    return this[25].toTuple() as InitializeCallTermsContractReference_2Struct;
  }
}
