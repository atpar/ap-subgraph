...
export class ANNRegistry__decodeCollateralObjectResult {
  value0: Address;
  value1: BigInt;
...
export class ANNRegistry extends SmartContract {
  ...
  decodeCollateralObject(
    object: Bytes
  ): ANNRegistry__decodeCollateralObjectResult {
    let result = super.call("decodeCollateralObject", [
      EthereumValue.fromFixedBytes(object)
    ]);

    return new ANNRegistry__decodeCollateralObjectResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_decodeCollateralObject(
    object: Bytes
  ): CallResult<ANNRegistry__decodeCollateralObjectResult> {
    ...
    return CallResult.fromValue(
      new ANNRegistry__decodeCollateralObjectResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
