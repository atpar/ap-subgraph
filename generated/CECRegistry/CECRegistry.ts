...
export class CECRegistry__getFinalizedStateResultValue0Struct extends EthereumTuple {
...
export class CECRegistry__getOwnershipResultValue0Struct extends EthereumTuple {
...
export class CECRegistry__getStateResultValue0Struct extends EthereumTuple {
  get contractPerformance(): i32 {
    return this[0].toI32();
  }
...
export class CECRegistry__isEventSettledResult {
  value0: boolean;
  value1: BigInt;
...
export class CECRegistry__getTermsResultValue0Struct extends EthereumTuple {
  ...
  get contractReference_1(): CECRegistry__getTermsResultValue0ContractReference_1Struct {
    return this[13].toTuple() as CECRegistry__getTermsResultValue0ContractReference_1Struct;
  }

  get contractReference_2(): CECRegistry__getTermsResultValue0ContractReference_2Struct {
    return this[14].toTuple() as CECRegistry__getTermsResultValue0ContractReference_2Struct;
  }
}

export class CECRegistry__getTermsResultValue0ContractReference_1Struct extends EthereumTuple {
  get object(): Bytes {
...
export class CECRegistry__getTermsResultValue0ContractReference_2Struct extends EthereumTuple {
  get object(): Bytes {
    return this[0].toBytes();
  }
...
export class CECRegistry__getPeriodValueForTermsAttributeResultValue0Struct extends EthereumTuple {
  get i(): BigInt {
...
export class CECRegistry__getCycleValueForTermsAttributeResultValue0Struct extends EthereumTuple {
  get i(): BigInt {
    return this[0].toBigInt();
  }
...
export class CECRegistry__getContractReferenceValueForTermsAttributeResultValue0Struct extends EthereumTuple {
  get object(): Bytes {
    return this[0].toBytes();
  }
...
export class CECRegistry extends SmartContract {
  static bind(address: Address): CECRegistry {
  ...
  decodeEvent(_event: Bytes): CECRegistry__decodeEventResult {
    ...
    return new CECRegistry__decodeEventResult(
      result[0].toI32(),
      result[1].toBigInt()
    );
  }

  try_decodeEvent(_event: Bytes): CallResult<CECRegistry__decodeEventResult> {
  ...
  getFinalizedState(
    assetId: Bytes
  ): CECRegistry__getFinalizedStateResultValue0Struct {
    let result = super.call("getFinalizedState", [
      EthereumValue.fromFixedBytes(assetId)
    ]);

    return result[0].toTuple() as CECRegistry__getFinalizedStateResultValue0Struct;
  }

  try_getFinalizedState(
    assetId: Bytes
  ): CallResult<CECRegistry__getFinalizedStateResultValue0Struct> {
    ...
    let value = result.value;
    return CallResult.fromValue(
      value[0].toTuple() as CECRegistry__getFinalizedStateResultValue0Struct
    );
  }
  ...
  getOwnership(assetId: Bytes): CECRegistry__getOwnershipResultValue0Struct {
    let result = super.call("getOwnership", [
      EthereumValue.fromFixedBytes(assetId)
    ]);

    return result[0].toTuple() as CECRegistry__getOwnershipResultValue0Struct;
  }

  try_getOwnership(
    assetId: Bytes
  ): CallResult<CECRegistry__getOwnershipResultValue0Struct> {
    ...
    let value = result.value;
    return CallResult.fromValue(
      value[0].toTuple() as CECRegistry__getOwnershipResultValue0Struct
    );
  }
  ...
  getState(assetId: Bytes): CECRegistry__getStateResultValue0Struct {
    let result = super.call("getState", [
      EthereumValue.fromFixedBytes(assetId)
    ]);

    return result[0].toTuple() as CECRegistry__getStateResultValue0Struct;
  }

  try_getState(
    assetId: Bytes
  ): CallResult<CECRegistry__getStateResultValue0Struct> {
    ...
    let value = result.value;
    return CallResult.fromValue(
      value[0].toTuple() as CECRegistry__getStateResultValue0Struct
    );
  }
  ...
  isEventSettled(
    assetId: Bytes,
    _event: Bytes
  ): CECRegistry__isEventSettledResult {
    let result = super.call("isEventSettled", [
      EthereumValue.fromFixedBytes(assetId),
      EthereumValue.fromFixedBytes(_event)
    ]);

    return new CECRegistry__isEventSettledResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }
  ...
  try_isEventSettled(
    assetId: Bytes,
    _event: Bytes
  ): CallResult<CECRegistry__isEventSettledResult> {
    ...
    let value = result.value;
    return CallResult.fromValue(
      new CECRegistry__isEventSettledResult(
        value[0].toBoolean(),
        value[1].toBigInt()
      )
    );
  ...
  getTerms(assetId: Bytes): CECRegistry__getTermsResultValue0Struct {
    let result = super.call("getTerms", [
      EthereumValue.fromFixedBytes(assetId)
    ]);

    return result[0].toTuple() as CECRegistry__getTermsResultValue0Struct;
  }

  try_getTerms(
    assetId: Bytes
  ): CallResult<CECRegistry__getTermsResultValue0Struct> {
    ...
    let value = result.value;
    return CallResult.fromValue(
      value[0].toTuple() as CECRegistry__getTermsResultValue0Struct
    );
  }
  ...
  getPeriodValueForTermsAttribute(
    assetId: Bytes,
    attribute: Bytes
  ): CECRegistry__getPeriodValueForTermsAttributeResultValue0Struct {
    let result = super.call("getPeriodValueForTermsAttribute", [
      EthereumValue.fromFixedBytes(assetId),
      EthereumValue.fromFixedBytes(attribute)
    ]);

    return result[0].toTuple() as CECRegistry__getPeriodValueForTermsAttributeResultValue0Struct;
  }
  ...
  > {
    ...
    let value = result.value;
    return CallResult.fromValue(
      value[0].toTuple() as CECRegistry__getPeriodValueForTermsAttributeResultValue0Struct
    );
  }
  ...
  getCycleValueForTermsAttribute(
    assetId: Bytes,
    attribute: Bytes
  ): CECRegistry__getCycleValueForTermsAttributeResultValue0Struct {
    let result = super.call("getCycleValueForTermsAttribute", [
      EthereumValue.fromFixedBytes(assetId),
      EthereumValue.fromFixedBytes(attribute)
    ]);

    return result[0].toTuple() as CECRegistry__getCycleValueForTermsAttributeResultValue0Struct;
  }

  try_getCycleValueForTermsAttribute(
    assetId: Bytes,
    attribute: Bytes
  ): CallResult<CECRegistry__getCycleValueForTermsAttributeResultValue0Struct> {
    ...
    let value = result.value;
    return CallResult.fromValue(
      value[0].toTuple() as CECRegistry__getCycleValueForTermsAttributeResultValue0Struct
    );
  }
  ...
  getContractReferenceValueForTermsAttribute(
    assetId: Bytes,
    attribute: Bytes
  ): CECRegistry__getContractReferenceValueForTermsAttributeResultValue0Struct {
    let result = super.call("getContractReferenceValueForTermsAttribute", [
      EthereumValue.fromFixedBytes(assetId),
      EthereumValue.fromFixedBytes(attribute)
    ]);

    return result[0].toTuple() as CECRegistry__getContractReferenceValueForTermsAttributeResultValue0Struct;
  }
  ...
  > {
    ...
    let value = result.value;
    return CallResult.fromValue(
      value[0].toTuple() as CECRegistry__getContractReferenceValueForTermsAttributeResultValue0Struct
    );
  }
}
...
export class RegisterAssetCallTermsStruct extends EthereumTuple {
  ...
  get contractReference_1(): RegisterAssetCallTermsContractReference_1Struct {
    return this[13].toTuple() as RegisterAssetCallTermsContractReference_1Struct;
  }

  get contractReference_2(): RegisterAssetCallTermsContractReference_2Struct {
    return this[14].toTuple() as RegisterAssetCallTermsContractReference_2Struct;
  }
}
...
export class SetTermsCallTermsStruct extends EthereumTuple {
  ...
  get contractReference_1(): SetTermsCallTermsContractReference_1Struct {
    return this[13].toTuple() as SetTermsCallTermsContractReference_1Struct;
  }

  get contractReference_2(): SetTermsCallTermsContractReference_2Struct {
    return this[14].toTuple() as SetTermsCallTermsContractReference_2Struct;
  }
}
