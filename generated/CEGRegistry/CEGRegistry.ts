...
export class CEGRegistry__decodeCollateralObjectResult {
  value0: Address;
  value1: BigInt;
...
export class CEGRegistry extends SmartContract {
  ...
  decodeCollateralObject(
    object: Bytes
  ): CEGRegistry__decodeCollateralObjectResult {
    let result = super.call("decodeCollateralObject", [
      EthereumValue.fromFixedBytes(object)
    ]);

    return new CEGRegistry__decodeCollateralObjectResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_decodeCollateralObject(
    object: Bytes
  ): CallResult<CEGRegistry__decodeCollateralObjectResult> {
    ...
    return CallResult.fromValue(
      new CEGRegistry__decodeCollateralObjectResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
